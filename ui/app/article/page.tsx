...
const Page = () => {
  ...
  return loading ? (
    ...
    <div>
      ...
      <div className="flex flex-col pt-16 lg:pt-24 mt-5">
       <div className='flex flex-row justify-between items-center'>
          <div className='flex flex-row items-center space-x-2'>
            {/* <Layers3 />
            <h4 className="text-black dark:text-white lg:medium lg:font-small">
              Article
            </h4> */}
          </div>
          <div>
            <Link href={'/article/create'} className='flex flex-row items-center space-x-2'>
            ...
            >
              ...
              <div className="flex flex-row items-center justify-between w-full">
                <div className="flex flex-row items-center space-x-1 lg:space-x-1.5 text-black/70 dark:text-white/70">
                  <ClockIcon size={15} />
                  <p className="text-xs">
                    {formatTimeDifference(new Date(), item.createdAt)} Ago
                  </p>
                </div>
                <DeleteArticle
                  dataId={item.id}
